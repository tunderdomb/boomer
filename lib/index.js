...
module.exports = function ( grunt, taskName ){
  ...
  boomer.express = function ( app, setupApp ){
    require("./expressTask")(grunt, taskName, app, setupApp, runOptions)
    return boomer
  }

  boomer.connect = function ( options ){
    require("./connectTask")(grunt, taskName, options, runOptions)
    return boomer
  }
